...
import morningIcon from "@/public/icons/morning.svg"
import afternoonIcon from "@/public/icons/afternoon.svg"
import eveningIcon from "@/public/icons/evening.svg"
        ...
        <>
            ...
            <VStack className="w-full space-y-2">
                <CheckButton
                    ...
                    onClick={() => { onClick(0) }}
                >
                    <Image style={{ marginTop: "4px", marginRight: "8px" }} src={morningIcon} alt="ic_morning" layout="intrinsic" width="20px" height="20px" />
                ...
                <CheckButton
                    ...
                    onClick={() => { onClick(1) }}
                >
                    <Image style={{ marginTop: "4px", marginRight: "8px" }} src={afternoonIcon} alt="ic_afternoon" width="20px" height="20px" />
                ...
                <CheckButton
                    ...
                    onClick={() => { onClick(2) }}
                >
                    <Image style={{ marginTop: "4px", marginRight: "8px" }} src={eveningIcon} alt="ic_afternoon" width="20px" height="20px" />
